...
namespace AtmosphericDamage
{
    public static class Config
    {
        ...
        public const string PLANET_NAME = "Ciybos"; //this mod targets planet Kumous
        public const float LARGE_SHIP_DAMAGE = 2.5f; //applies 2.5 damage to each block per update
        public const float SMALL_SHIP_DAMAGE = 1.25f;
        public const string DAMAGE_STRING = PLANET_NAME + "Atmosphere";
        public const float PLAYER_DAMAGE_AMOUNT = 2f;

        public const double EMITTER_DRAW_DIST = 10000;
        public static bool DAMAGE_PLAYERS = false; //set true to apply atmospheric damage to players
        public static bool ACID_RAIN = false; //set true to apply damage only from above (like acid rain)
        ...
        public static bool VOXEL_DAMAGE = true; //allow certain voxel types to deal damage
        ...
        public const int UPDATE_RATE = 200; //damage will apply every 200 frames. MUST ALWAYS BE DIVISIBLE BY 10!
        public const int MAX_QUEUE = UPDATE_RATE * 4; //damage 4 objects per tick
